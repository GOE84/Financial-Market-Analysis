...
สรุปผลการทำนายราคาทองคำ (สำหรับ Git Markdown):
ภาพรวมโมเดล
...
ขั้นตอนการดำเนินงาน:
การรวบรวมข้อมูล: ดึงข้อมูลราคาทองคำในอดีตจาก Yahoo Finance (yfinance).
การสร้างคุณลักษณะ (Feature Engineering): คำนวณค่าเฉลี่ยเคลื่อนที่ (Moving Averages) 10 วัน (MA_10) และ 50 วัน (MA_50), อัตราผลตอบแทนรายวัน (Daily_Return) และราคาปิดของวันก่อนหน้า (Close_Lag1) นอกจากนี้ยังสร้างตัวแปรเป้าหมาย (Prediction) คือราคาปิดของวันถัดไป.
การทำความสะอาดข้อมูล: ลบแถวที่มีค่าว่าง (NaN) ซึ่งเกิดขึ้นจากการสร้างคุณลักษณะ.
การแบ่งข้อมูล: แบ่งข้อมูลออกเป็นชุดฝึก (80%) และชุดทดสอบ (20%) ตามลำดับเวลา.
การฝึกโมเดล: ฝึกโมเดล Linear Regression ด้วยชุดข้อมูลฝึก.
การประเมินผล: ประเมินประสิทธิภาพของโมเดลบนชุดข้อมูลทดสอบโดยใช้ Root Mean Squared Error (RMSE).
การแสดงผล: พล็อตเปรียบเทียบราคาทองคำจริงกับราคาที่โมเดลทำนายได้.
ผลการทำนาย
